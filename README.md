...
The full notebooks, all zipped, with the outputs are contained within the zenodo repo with the accompanying DOI: 10.5281/zenodo.8037425 (unpublished for now).  
